...
public final class ADivididoExprLogica extends PExprLogica
{
    private PExprLogica _l_;
    private PExprLogica _r_;

    public ADivididoExprLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADivididoExprLogica(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseADivididoExprLogica(this);
    }
