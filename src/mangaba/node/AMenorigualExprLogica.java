...
public final class AMenorigualExprLogica extends PExprLogica
{
    private PExprLogica _l_;
    private PExprLogica _r_;

    public AMenorigualExprLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorigualExprLogica(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseAMenorigualExprLogica(this);
    }
