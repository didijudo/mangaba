...
public final class AMaiorigualExprLogica extends PExprLogica
{
    private PExprLogica _l_;
    private PExprLogica _r_;

    public AMaiorigualExprLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorigualExprLogica(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseAMaiorigualExprLogica(this);
    }
